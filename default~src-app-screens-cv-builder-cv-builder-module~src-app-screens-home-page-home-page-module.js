(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~src-app-screens-cv-builder-cv-builder-module~src-app-screens-home-page-home-page-module"],{
...
class ApisService {
    ...
    getCounter() {
        return this.http.get(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiUrl}counter`);
    }
    downloadCV(value) {
        return this.http.post(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].apiUrl}template`, value);
    }
}
ApisService.ɵfac = function ApisService_Factory(t) { return new (t || ApisService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"])); };
...
//# sourceMappingURL=default~src-app-screens-cv-builder-cv-builder-module~src-app-screens-home-page-home-page-module.js.map